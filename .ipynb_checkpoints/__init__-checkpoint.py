...
if __name__ == '__main__':
    ...
    #   3 - tylko nowe ogloszenia (dodac robienie odp. kolumn w csv/df)
    ...
    if opcja == 1:
        parser = OtodomParser(url, 1, slownik_warstw, # warstwy GIS
    ...
    # elif opcja == 3:
    #    parser = OtodomParser(url, 2, slownik_warstw, filename_new, filename_new, folder)
    #    parser.parse()
    #    parser.spacjalizuj()
    #    parser.analizuj_df()
